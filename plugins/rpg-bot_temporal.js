...
let texto0 = `${ag}𝙈𝙀𝙐 𝘾𝙍𝙄𝘼𝘿𝙊𝙍 𝙍𝙀𝙎𝙏𝙍𝙄𝙉𝙂𝙄𝙐 𝙀𝙎𝙏𝙀 𝙍𝙀𝘾𝙐𝙍𝙎𝙊 𝘿𝙀 𝙄𝙉𝙂𝙍𝙀𝙎𝙎𝘼𝙍 𝙏𝙀𝙈𝙋𝙊𝙍𝘼𝙍𝙄𝘼𝙈𝙀𝙉𝙏𝙀 𝙊 𝘽𝙊𝙏 𝘼 𝙂𝙍𝙐𝙋𝙊𝙎 𝙋𝙊𝙍 𝙁𝘼𝙑𝙊𝙍, 𝙑𝙊𝙇𝙏𝙀 𝙈𝘼𝙄𝙎 𝙏𝘼𝙍𝘿𝙀 𝙊𝙐 𝙐𝙎𝙀 𝙊 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 *${usedPrefix}serbot*`
