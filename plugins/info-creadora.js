...
Sejam Bem vindos aqui, qualquer dúvida chame no pv/`
...
description = official[0][0] == String(contact[0]) ? 'Sou a GataBot' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
...
lugar = official[0][0] == String(contact[0]) ? '🇧🇷 Brasil' : official[1][0] == String(contact[0]) ? '🇧🇷 Brasil' : official[2][0] == String(contact[0]) ? '🇲🇽 México' : official[3][0] == String(contact[0]) ? '🇧🇷 Brazil' : country === '' ? lenguajeGB.smsContacto7() : country
...
console.log(e)}} 
handler.help = ['owner', 'criador']
handler.tags = ['info']
handler.command = /^(owner|criador|propietario|dueño|dueña|propietaria|dueño|creadora|creador|contactos?|contacts?)$/i
